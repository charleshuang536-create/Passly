          ...
          >
            <div className="relative z-10 mx-auto max-w-[300px] aspect-[9/19] bg-black rounded-[3rem] border-[8px] border-zinc-800 shadow-2xl overflow-hidden">
              ...
              <div className="p-4 pt-12 h-full bg-zinc-900 flex flex-col gap-4">
                <div className="w-full aspect-[1.6/1] bg-gradient-to-br from-blue-600 to-indigo-700 rounded-xl p-4 flex flex-col justify-between shadow-lg">
            ...
            {/* Floating elements */}
            <div className="absolute top-1/4 -left-4 md:-left-20 p-4 bg-white dark:bg-zinc-900 rounded-2xl shadow-xl border border-border flex items-center gap-3 animate-bounce-slow">
            ...
            <div className="absolute bottom-1/4 -right-4 md:-right-20 p-4 bg-white dark:bg-zinc-900 rounded-2xl shadow-xl border border-border flex items-center gap-3 animate-bounce-slow-delayed">
